...
">
    ...
    <div style="margin-top: 20px;">
            ...
            <button type="button" style="width: 15%;" <?php if($rowTransaksi['dibayar'] == 'dibayar') echo "hidden" ?> class="custom-btn btn-1" onclick="openModal('modaltambahpaket')">
                Tambah Paket
            </button>
            <button type="button" class="custom-btn btn-1" style="width: 15%;" <?php if($rowTransaksi['dibayar'] == 'dibayar') echo "hidden" ?> onclick="openModal('modalbayar')">
                Pay Now
            </button>
            <a href="./dashboard.php?page=transaksi" <?php if($rowTransaksi['dibayar'] == 'dibayar') echo "hidden" ?> style="width: 15%;" class="btn-1 custom-btn">Pay Later</a>
            <a href="../view/dashboard.php?page=show-" <?php if($rowTransaksi['dibayar'] == 'belum_dibayar') echo "hidden" ?> class="custom-btn btn-1">Print</a>
    </div>
